...
class AppConfig:
    ...
    label_alternate_seconds: int = 0
    label_show_usd: bool = True
    label_show_tokens: bool = False
    label_show_plan: bool = False
    ...
    def load(cls) -> "AppConfig":
        ...
        config = cls(
            ...
            label_alternate_seconds=max(0, int(data.get("label_alternate_seconds", 0))),
            label_show_usd=bool(data.get("label_show_usd", True)),
            label_show_tokens=bool(data.get("label_show_tokens", False)),
            label_show_plan=bool(data.get("label_show_plan", False)),
